...
## 任务
实现 Phase4 任务：T-442: /projects/:id/timeline** - 时间线视图
...
[7m[1m[36m RUN [39m[22m[27m [36mv1.6.1[39m [90mD:/project/aicoding/OpenClawHub/frontend[39m
 ...
 [32m✓[39m src/views/__tests__/RegisterView.spec.ts [2m ([22m[2m2 tests[22m[2m)[22m[90m 131[2mms[22m[39m
 [33m❯[39m src/views/__tests__/LoginView.spec.ts [2m ([22m[2m2 tests[22m [2m|[22m [31m2 failed[39m[2m)[22m[33m 392[2mms[22m[39m
...
[2m   Start at [22m 20:21:42
[2m   Duration [22m 3.59s[2m (transform 2.23s, setup 0ms, collect 6.04s, tests 885ms, environment 11.58s, prepare 2.50s)[22m
