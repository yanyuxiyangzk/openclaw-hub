...
## 任务
实现 Phase5 任务：T-510: POST /api/scheduler/jobs** - 创建定时任务
...
[7m[1m[36m RUN [39m[22m[27m [36mv1.6.1[39m [90mD:/project/aicoding/OpenClawHub/frontend[39m
 ...
 [32m✓[39m src/views/__tests__/SettingsView.spec.ts [2m ([22m[2m2 tests[22m[2m)[22m[90m 79[2mms[22m[39m
 ...
 [33m❯[39m src/views/__tests__/LoginView.spec.ts [2m ([22m[2m2 tests[22m [2m|[22m [31m2 failed[39m[2m)[22m[33m 409[2mms[22m[39m
...
[2m   Start at [22m 22:18:15
[2m   Duration [22m 3.96s[2m (transform 2.11s, setup 2ms, collect 6.19s, tests 916ms, environment 13.68s, prepare 2.37s)[22m
