...
## 任务
实现 Phase5 任务：T-512: DELETE /api/scheduler/jobs/{id}** - 删除定时任务
...
[7m[1m[36m RUN [39m[22m[27m [36mv1.6.1[39m [90mD:/project/aicoding/OpenClawHub/frontend[39m
 ...
 [32m✓[39m src/views/__tests__/OrgListView.spec.ts [2m ([22m[2m2 tests[22m[2m)[22m[90m 71[2mms[22m[39m
 ...
 [32m✓[39m src/views/__tests__/InvitationView.spec.ts [2m ([22m[2m2 tests[22m[2m)[22m[90m 58[2mms[22m[39m
...
[2m   Start at [22m 22:29:26
[2m   Duration [22m 4.06s[2m (transform 2.56s, setup 1ms, collect 6.51s, tests 962ms, environment 13.03s, prepare 2.53s)[22m
