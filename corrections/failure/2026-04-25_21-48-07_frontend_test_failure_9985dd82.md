...
## 任务
实现 Phase5 任务：T-505: POST /api/executions/{id}/cancel** - 取消执行
...
[7m[1m[36m RUN [39m[22m[27m [36mv1.6.1[39m [90mD:/project/aicoding/OpenClawHub/frontend[39m
 ...
 [33m❯[39m src/views/__tests__/LoginView.spec.ts [2m ([22m[2m2 tests[22m [2m|[22m [31m2 failed[39m[2m)[22m[33m 396[2mms[22m[39m
...
[2m   Start at [22m 21:48:03
[2m   Duration [22m 3.76s[2m (transform 2.23s, setup 2ms, collect 6.49s, tests 895ms, environment 11.81s, prepare 2.65s)[22m
