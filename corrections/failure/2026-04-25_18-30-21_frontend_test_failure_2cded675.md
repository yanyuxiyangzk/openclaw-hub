...
## 任务
实现 Phase4 任务：T-415: POST /api/tasks/{id}/subtasks** - 创建子任务
...
[7m[1m[36m RUN [39m[22m[27m [36mv1.6.1[39m [90mD:/project/aicoding/OpenClawHub/frontend[39m
 ...
 [32m✓[39m src/views/__tests__/MemberManageView.spec.ts [2m ([22m[2m2 tests[22m[2m)[22m[90m 79[2mms[22m[39m
 [32m✓[39m src/views/__tests__/SettingsView.spec.ts [2m ([22m[2m2 tests[22m[2m)[22m[90m 90[2mms[22m[39m
 [32m✓[39m src/views/__tests__/RegisterView.spec.ts [2m ([22m[2m2 tests[22m[2m)[22m[90m 194[2mms[22m[39m
...
[2m   Start at [22m 18:30:16
[2m   Duration [22m 4.72s[2m (transform 2.12s, setup 6ms, collect 6.16s, tests 1.01s, environment 17.23s, prepare 3.18s)[22m
