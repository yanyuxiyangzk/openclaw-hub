...
## 任务
实现 Phase4 任务：T-421: GET /api/projects/{id}/tasks/by-status** - 按状态
...
[7m[1m[36m RUN [39m[22m[27m [36mv1.6.1[39m [90mD:/project/aicoding/OpenClawHub/frontend[39m
 ...
 [33m❯[39m src/views/__tests__/LoginView.spec.ts [2m ([22m[2m2 tests[22m [2m|[22m [31m2 failed[39m[2m)[22m[33m 446[2mms[22m[39m
...
[2m   Start at [22m 19:00:04
[2m   Duration [22m 4.25s[2m (transform 2.34s, setup 2ms, collect 6.50s, tests 975ms, environment 14.77s, prepare 2.71s)[22m
