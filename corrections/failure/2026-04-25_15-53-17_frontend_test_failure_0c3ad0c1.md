...
## 任务
实现 Phase3 任务：T-332: /agents/:id/metrics** - Agent指标面板
...
[7m[1m[36m RUN [39m[22m[27m [36mv1.6.1[39m [90mD:/project/aicoding/OpenClawHub/frontend[39m
 ...
 [32m✓[39m src/views/__tests__/MemberManageView.spec.ts [2m ([22m[2m2 tests[22m[2m)[22m[90m 80[2mms[22m[39m
 ...
 [32m✓[39m src/views/__tests__/RegisterView.spec.ts [2m ([22m[2m2 tests[22m[2m)[22m[90m 155[2mms[22m[39m
 [33m❯[39m src/views/__tests__/LoginView.spec.ts [2m ([22m[2m2 tests[22m [2m|[22m [31m2 failed[39m[2m)[22m[33m 440[2mms[22m[39m
...
[2m   Duration [22m 4.03s[2m (transform 2.42s, setup 3ms, collect 6.68s, tests 983ms, environment 13.54s, prepare 2.33s)[22m
