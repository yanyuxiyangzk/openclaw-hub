...
## 任务
实现 Phase4 任务：T-410: POST /api/tasks/{id}/assign** - 指派任务
...
[7m[1m[36m RUN [39m[22m[27m [36mv1.6.1[39m [90mD:/project/aicoding/OpenClawHub/frontend[39m
 ...
 [32m✓[39m src/views/__tests__/RegisterView.spec.ts [2m ([22m[2m2 tests[22m[2m)[22m[90m 136[2mms[22m[39m
 [33m❯[39m src/views/__tests__/LoginView.spec.ts [2m ([22m[2m2 tests[22m [2m|[22m [31m2 failed[39m[2m)[22m[33m 412[2mms[22m[39m
...
[2m   Start at [22m 17:46:51
[2m   Duration [22m 3.67s[2m (transform 2.33s, setup 2ms, collect 5.98s, tests 948ms, environment 11.66s, prepare 2.69s)[22m
