...
## 任务
实现 Phase5 任务：T-504: GET /api/tasks/{id}/executions** - 任务执行历史
...
[7m[1m[36m RUN [39m[22m[27m [36mv1.6.1[39m [90mD:/project/aicoding/OpenClawHub/frontend[39m
 ...
 [32m✓[39m src/views/__tests__/OrgListView.spec.ts [2m ([22m[2m2 tests[22m[2m)[22m[90m 81[2mms[22m[39m
 ...
 [33m❯[39m src/views/__tests__/LoginView.spec.ts [2m ([22m[2m2 tests[22m [2m|[22m [31m2 failed[39m[2m)[22m[33m 452[2mms[22m[39m
...
[2m   Duration [22m 4.25s[2m (transform 2.79s, setup 1ms, collect 7.36s, tests 978ms, environment 14.44s, prepare 2.58s)[22m
